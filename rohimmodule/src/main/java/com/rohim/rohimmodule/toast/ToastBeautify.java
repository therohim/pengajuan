package com.rohim.rohimmodule.toast;
...
import com.rohim.rohimmodule.R;

public class ToastBeautify {
    ...
    public static Toast normal(@NonNull Context context, @StringRes int message, int duration,
        ...
        return custom(context, context.getString(message), icon, ToastBeautifyUtils.getColor(context, R.color.normalColor),
                ToastBeautifyUtils.getColor(context, R.color.defaultTextColor), duration, withIcon, true);
    }

    @CheckResult
    public static Toast normal(@NonNull Context context, @NonNull CharSequence message, int duration,
                               Drawable icon, boolean withIcon) {
        return custom(context, message, icon, ToastBeautifyUtils.getColor(context, R.color.normalColor),
                ToastBeautifyUtils.getColor(context, R.color.defaultTextColor), duration, withIcon, true);
    }
    ...
    public static Toast warning(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastBeautifyUtils.getDrawable(context, R.drawable.ic_error_outline_white_24dp),
                ToastBeautifyUtils.getColor(context, R.color.warningColor), ToastBeautifyUtils.getColor(context, R.color.defaultTextColor),
    ...
    public static Toast warning(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastBeautifyUtils.getDrawable(context, R.drawable.ic_error_outline_white_24dp),
                ToastBeautifyUtils.getColor(context, R.color.warningColor), ToastBeautifyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastBeautifyUtils.getDrawable(context, R.drawable.ic_info_outline_white_24dp),
                ToastBeautifyUtils.getColor(context, R.color.infoColor), ToastBeautifyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast info(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastBeautifyUtils.getDrawable(context, R.drawable.ic_info_outline_white_24dp),
                ToastBeautifyUtils.getColor(context, R.color.infoColor), ToastBeautifyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastBeautifyUtils.getDrawable(context, R.drawable.ic_check_white_24dp),
                ToastBeautifyUtils.getColor(context, R.color.successColor), ToastBeautifyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast success(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastBeautifyUtils.getDrawable(context, R.drawable.ic_check_white_24dp),
                ToastBeautifyUtils.getColor(context, R.color.successColor), ToastBeautifyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastBeautifyUtils.getDrawable(context, R.drawable.ic_clear_white_24dp),
                ToastBeautifyUtils.getColor(context, R.color.errorColor), ToastBeautifyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast error(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastBeautifyUtils.getDrawable(context, R.drawable.ic_clear_white_24dp),
                ToastBeautifyUtils.getColor(context, R.color.errorColor), ToastBeautifyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, -1, ToastBeautifyUtils.getColor(context, R.color.defaultTextColor),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               int duration, boolean withIcon) {
        return custom(context, message, icon, -1, ToastBeautifyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, false);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, @DrawableRes int iconRes,
        ...
        return custom(context, context.getString(message), ToastBeautifyUtils.getDrawable(context, iconRes),
                ToastBeautifyUtils.getColor(context, tintColorRes), ToastBeautifyUtils.getColor(context, R.color.defaultTextColor),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, @DrawableRes int iconRes,
                               @ColorRes int tintColorRes, int duration,
                               boolean withIcon, boolean shouldTint) {
        return custom(context, message, ToastBeautifyUtils.getDrawable(context, iconRes),
                ToastBeautifyUtils.getColor(context, tintColorRes), ToastBeautifyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
                               @ColorRes int tintColorRes, int duration,
                               boolean withIcon, boolean shouldTint) {
        return custom(context, context.getString(message), icon, ToastBeautifyUtils.getColor(context, tintColorRes),
                ToastBeautifyUtils.getColor(context, R.color.defaultTextColor), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
                               ...
                               boolean withIcon, boolean shouldTint) {
        return custom(context, context.getString(message), icon, ToastBeautifyUtils.getColor(context, tintColorRes),
                ToastBeautifyUtils.getColor(context, textColorRes), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        if (shouldTint)
            drawableFrame = ToastBeautifyUtils.tint9PatchDrawableFrame(context, tintColor);
        else
            drawableFrame = ToastBeautifyUtils.getDrawable(context, R.drawable.toast_frame);
        ToastBeautifyUtils.setBackground(toastLayout, drawableFrame);

        if (withIcon) {
            if (icon == null)
                throw new IllegalArgumentException("Avoid passing 'icon' as null if 'withIcon' is set to true");
            ToastBeautifyUtils.setBackground(toastIcon, tintIcon ? ToastBeautifyUtils.tintIcon(icon, textColor) : icon);
        } else {
    ...
    public static class Config {
        private Typeface typeface = ToastBeautify.currentTypeface;
        private int textSize = ToastBeautify.textSize;

        private boolean tintIcon = ToastBeautify.tintIcon;
        ...
        public static void reset() {
            ToastBeautify.currentTypeface = LOADED_TOAST_TYPEFACE;
            ToastBeautify.textSize = 16;
            ToastBeautify.tintIcon = true;
            ToastBeautify.allowQueue = true;
        }
        ...
        public void apply() {
            ToastBeautify.currentTypeface = typeface;
            ToastBeautify.textSize = textSize;
            ToastBeautify.tintIcon = tintIcon;
            ToastBeautify.allowQueue = allowQueue;
        }
    }
}
